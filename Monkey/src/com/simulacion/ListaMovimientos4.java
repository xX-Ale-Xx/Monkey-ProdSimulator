...
public class ListaMovimientos4  extends  Thread{
    JLabel circulo;
    int posInicialX;
    int posFinalX;
    int posInicialY;
    ...
    public ListaMovimientos4(JFrame panel) {
        //this.circulo = circulo;
        this.posInicialX = 540;
        this.posFinalX = 540;
    ...
    public void run(){
        while (ejecutar) {            
            try {
                ...
                Logger.getLogger(ListaMovimientos4.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
      ...
      private void CrearCirculo(){
          ...
          EmpaquetadoToSalida mov1 = new EmpaquetadoToSalida(circulo, posInicialX, posFinalX, posInicialY, posFinalY);
            mov1.start();
            contador++;
      }       
      
      private void mostrarImagen(JLabel cuadro){
        String ruta ="./src/com/img/morado.png";
        if(!ruta.equals("")){
